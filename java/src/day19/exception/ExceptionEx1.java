...
public class ExceptionEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 하지만, 예외가 발생해서 프로그램이 중단(ArithmeticException이 발생= RuntimeException 클래스의 자식 클래스)
...
class A implements Cloneable{
	...
	//RuntimeException 클래스의 자식 클래스는 생략가능
	public void test() /*throws ArithmeticException 생략*/ {
