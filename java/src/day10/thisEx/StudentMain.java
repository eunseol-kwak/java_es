...
public class StudentMain {
	...
	public static void main(String[] args) {
		...
		//std2.studentCount = 1;
		//System.out.println(std1.studentCount); //The static field Student1.studentCount should be accessed in a static way
		std1.print();
...
class Student1{
	...
	public Student1() {
		...
		//int grade = 10;
		//this.grade = grade;
		this(1,1,1,""); // 다른 생성자 호출시 첫 라인에 써야함
		name = "";
		/*this.grade = 1;
		classNum = 1;
		number = 1;
	...
	public static void printCount() {
		...
		//객체 변수 사용 불가능(직접 사용 불가능)
		//grade = 1;
		//객체 메서드 사용 불가능(직접 사용 불가능)
		//print();
		//객체를 생성 후 호출해서 사용 가능
