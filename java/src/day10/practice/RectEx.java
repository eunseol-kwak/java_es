...
class Rect1 {
	...
	//getter와 setter 
	//생략. 여기서는 필요 없음/기능을 통해서 바꾸기 때문에 여기서는 필요없음, 좌표를 직접입력하지X
	
	//메서드
	/** 사각형 정보를 출력하는 메서드
	 * 매개변수: 없음(사각형이 내정보이기 때문에 없음)
	 * 리턴타입: 없음 => void
	 * 메소드명: print
	 * */
	public void print() {
	 ...
	 * (크기는 변하지 않고 위치만 이동:왼쪽위의좌표나 오른쪽아래좌표만 바뀜) 
	 * 리턴타입: 없음 => void
	 * 메소드명: move
	 * 0,0			=> 10,10
	 *     10,10				20,20
