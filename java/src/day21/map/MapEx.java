...
public class MapEx {
	...
	public static void main(String[] args) {
		/* Map을 배열처럼 사용하는 예제, 정수 배열/정수 리스트(쓰는경우 별로없음) */
		...
		map2.put("abc123","abc"); //key값이 중복된 정보를 추가 => key값은 중복X
		map2.put("zxc","abc");    //value값은 중복가능
		System.out.println(map2);
		
		
		/* keySet을 이용한 반복문(key값들을 하나의 Set으로 만들어서 반복)*/
		...
		while(it2.hasNext()) {
			...
			String id = tmp.getKey(); //getter 사용
