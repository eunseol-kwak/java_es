...
public class LottoEx {
	...
	public static void main(String[] args) {
		 ...
		 * bonus: 2 //컴퓨터는 보너스 번호를 포함해서 7개 생성
		 * user: 1 2 3 4 5 6 //사용자는 6개 생성
		 * losing ticket!
		 * */
	...
	/**일치하는 개수와 보너스 번호와 사용자 번호가 일치하는 여부를 알려주면 등수를 출력하는 메서드
	...
	public static void printResult(int count, boolean checkBonus) {
		...
		case 5:
			if(checkBonus) {
				System.out.println("2nd place in the lottery");
			}else {
				System.out.println("3rd place in the lottery");
			}
			break;
		case 4:
			System.out.println("4th placae in the lottery");
			break;
		case 3: 
			System.out.println("5th placae in the lottery");
			break;
		default:	
