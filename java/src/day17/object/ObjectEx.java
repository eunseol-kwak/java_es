...
public class ObjectEx {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		System.out.println(pt1.equals(pt11)); //=> true
		...
		System.out.println(pt2.equals(pt21)); //@Data 안함 /equals 오버라이딩 안하면 => false 
		
		System.out.println("===================");
		//clone()을 이용해서 복제가 제대로 됨
		Point2 pt22 = (Point2)pt2.clone(); //다운캐스팅 => (클래스명)을 반드시 추가
		//주소가 다르지만
		System.out.println(pt2 == pt22); //주소가 같은지 비교
		//두 객체가 같다고 판별
