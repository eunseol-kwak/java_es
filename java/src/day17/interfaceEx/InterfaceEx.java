...
public class InterfaceEx {
	 ...
	 *     구현 클래스인 ShopManager, VocaburaryNoteController의 객체가와서
	 *     프로그램을 실행할 수 있다. */
