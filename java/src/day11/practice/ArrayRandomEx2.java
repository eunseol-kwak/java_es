...
public class ArrayRandomEx2 {
	...
	public static void main(String[] args) {
		/* 1~9 사이의 랜덤한 수를 중복되지 않게 3개 만들어서 배열에 저장한 후 
		 * 출력하는 코드를 작성하세요. */
	...
	public static void printArray(int arr[]) {
		//i가 의미있게 쓰여지지 않게 때문에(밖에서 알려준게 의미가 없도록 바로 초기화, 매개변수 필요X) 
	...
	/** 정수 num가 배열의 0번지 부터 count개만큼 확인했을 떄 중복된 값이 있는지 없는지 알려주는 메서드
	 *  매개변수: 중복을 확인할 배열, 비교할 정수 num, 비교할 개수 count
	 *  		=> int arr[], int num, int count 
	 *  리턴타입: 있는지 없는지 => boolean
	 *  메서드명: contains
	 * */
	//main함수 static, 객체를 생성하지 않아서
