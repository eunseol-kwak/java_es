...
public class StringEx1 {
	...
	public static void main(String[] args) {
		/* 문자열 관련 메서드 */
		//indexOf : 기준 문자열에서 검색 문자/문자열을 앞에서부터(왼쪽부터) '처음'으로 만나는 위치(번지)를 반환 / 전부를 찾는게 아님
		String str = "Hello world";
		
		//str에서 7번지부터 wo가 있는지 확인. orld에서 wo가 있는지 확인 => 없음 => -1
		int index = str.indexOf("wo", 7); //7번지 부터 시작해서 wo를 찾으세요.
		...
		//lastIndexOf : 기준 문자열에서 검색 문자/문자열을 뒤에서부터(오른쪽부터) '처음'으로 만나는 위치(번지)를 반환
		...
		System.out.println(str + "에서 6번지 부터 가져온 부분 문자열 : " + str3);
